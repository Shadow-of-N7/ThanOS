...
public class IntList {
    private IntListElement _firstElement = null;
    private IntListElement _lastElement = null;
    ...
    public void add(int data) {
        IntListElement element = new IntListElement(data);
    ...
    public int elementAt(int index) {
        if(_elementCount > 0) {
            IntListElement currentElement = _firstElement;
    ...
    private static class IntListElement {
        int data;
        public IntListElement next = null;
        public IntListElement previous = null;

        public IntListElement(int data) {
            this.data = data;
        }
    }
}
