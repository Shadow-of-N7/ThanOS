...
public class LongList {
    private LongListElement _firstElement = null;
    private LongListElement _lastElement = null;
    ...
    public void add(long data) {
        LongListElement element = new LongListElement(data);
    ...
    public long elementAt(int index) {
        if(_elementCount > 0) {
            LongListElement currentElement = _firstElement;
    ...
    private static class LongListElement {
        long data;
        public LongListElement next = null;
        public LongListElement previous = null;

        public LongListElement(long data) {
            this.data = data;
        }
    }
}
