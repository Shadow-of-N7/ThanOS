...
public class BlueScreen {
    ...
    public static void raise(String source, String additionalInformation) {
        ...
        while (oldEBP >= 0x70000 && oldEBP <= 0x9FFFF) {
            // Skip the entry generated by the interrupt
            if(counter++ > 0) {
    ...
    private static int printCallstackEntry(int eip) {
        ...
        Console.print(' ');
        Console.print(searchMethod(SPackage.root.subPacks, eip));
        Console.println();
    ...
    /**
     * Finds a method corresponding to the given EIP address.
     * @param pack The root package.
     * @param eip The EIP for which to find the corresponding method.
     * @return The package, class and method name.
     */
    private static String searchMethod(SPackage pack, int eip) {
        SClassDesc clss;
        SMthdBlock mthd;
        ...
        while (pack != null) {
            if(pack.subPacks == null) {
                ...
                String result = searchMethod(pack.subPacks, eip);
